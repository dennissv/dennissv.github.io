 ...
 * Sun Feb 07 2021 20:04:31 GMT+0100 (Central European Standard Time)
...
operateAnimation('STOP', 'Drop2', null, null, 'AUTO', 1,
    ...
    changeVis('IntroText2', false);
changeVis('IntroText3', false);

registerOnClick('NextArrow', false, false, [0,1,2], function() {
  introStep = (typeof introStep == 'number' ? introStep : 0) + 1;
  if (introStep == 1) {
    changeVis('IntroText1', false);
    changeVis('IntroText2', true);
  }
  if (introStep == 2) {
    changeVis('IntroText2', false);
    changeVis('IntroText3', true);
  }
  if (introStep == 3) {
    changeVis('IntroText3', false);
